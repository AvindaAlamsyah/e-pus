...
<head>
	...
	<!-- Title Page-->
	<title>Akun Guru | Digital Library</title>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="overview-wrap m-b-35">
								<h2 class="title-1">Profile Akun</h2>
							</div>
							<div class="au-card">
								<div class="card">
									...
									<form action="<?php echo base_url('guru/akun/ganti_password'); ?>" method="post">
										<?php if (isset($pesan)) {
											echo $pesan;
										} ?>
										<div class="card-body card-block">
											<div class="form-group">
												...
												<input type="password" id="odl-password" name="old-password" class="form-control" required>
											</div>
											<div class="form-group">
												<label for="nf-password" class=" form-control-label">Password Baru</label>
												<input type="password" id="new-password" name="new-password" class="form-control" required>
											</div>
											<div class="form-group">
												<label for="nf-password" class=" form-control-label">Konfirmasi Password Baru</label>
